...
# Where to save the GBT model
MODEL_PATH = "/opt/spark/work-dir/fraud_gbt_unweighted_model"

# Start Spark
# can adjust number of partitions for more or less parallelism
spark = (
    SparkSession.builder
    .appName("Fraud_GBT_Unweighted")
...
# Gradient-Boosted Trees classifier (unweighted)
...
print("Training complete (Unweighted GBT).")
...
print("\n=== CONFUSION MATRIX (Unweighted GBT) ===")
