...
Below are the deployment instructions for the project using the Gradient Boost Trees mode for the predictions. The trained model is NOT included. The model must be retrained to generate the fraud_gpt_model before running streaming.


GitHub repository: https://github.com/stephanyyyyy/fraud-detector.git 
...
HDFS Setup
Enter the NameNode container and create HDFS directories. Copy dataset into :
...
/opt/spark/bin/spark-submit /appview_saved_predictions.py